...
export default {
  ...
  methods: {
    onPresetSelect(preset) {
      ...
      this.startDateTime = preset.startDate().format('YYYY-MM-DD\\THH:mm:ssZ');
      this.endDateTime = preset.endDate().format('YYYY-MM-DD\\THH:mm:ssZ');
    ...
    onDateRangeChange(data) {
      this.startDateTime = this.startDate ? moment(this.startDate).startOf('day').format('YYYY-MM-DD\\THH:mm:ssZ') : null;
      this.endDateTime = this.endDate ? moment(this.endDate).endOf('day').format('YYYY-MM-DD\\THH:mm:ssZ') : null;
